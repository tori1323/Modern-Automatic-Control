function Graphing_Obs(ans)
    ...
    stairs(logsout{6}.Values.Time',logsout{6}.Values.Data)
    hold off
    xlabel('Time (sec)')
    ylabel('x [m]')
    grid
    ...
    stairs(logsout{7}.Values.Time',-logsout{7}.Values.Data*180/pi)
    hold off
    xlabel('Time (sec)')
    ...
    stairs(logsout{8}.Values.Time',-logsout{8}.Values.Data*180/pi)
    ...
    subplot(3,1,1)
    stairs(logsout{4}.Values.Time',logsout{4}.Values.Data)
    xlabel('Time (sec)')
    ylabel('Force [kg*m/s^2]')
    subplot(3,1,2)
    stairs(logsout{5}.Values.Time',-logsout{5}.Values.Data)
    xlabel('Time (sec)')
    ylabel('Torque_1 [kg*(m/s)^2]')
    subplot(3,1,3)
    stairs(logsout{9}.Values.Time',-logsout{9}.Values.Data)
    xlabel('Time (sec)')
